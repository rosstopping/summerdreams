...
class CRMInConversation extends Lens
{
    public $name = 'In Conversation Leads';
    ...
    public static function query(LensRequest $request, $query)
    {
        return $request->withOrdering($request->withFilters(
            $query->crm()->where('crm->status', 'in-conversation')->orderBy('created_at', 'DESC')
        ));
    }
