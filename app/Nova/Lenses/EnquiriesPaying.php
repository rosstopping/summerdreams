...
class EnquiriesPaying extends Lens
{
    public $name = 'Paying';
    ...
    public static function query(LensRequest $request, $query)
    {
        return $request->withOrdering($request->withFilters(
            $query->enquiry()->where('enquiry_status', 'paying')->orderBy('enquired_at', 'DESC')
        ));
    }
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            DateTime::make('Date Paying', 'paying_at')->sortable(),
