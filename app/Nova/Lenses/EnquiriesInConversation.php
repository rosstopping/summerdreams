...
class EnquiriesInConversation extends Lens
{
    public $name = 'In Conversation';
    ...
    public static function query(LensRequest $request, $query)
    {
        return $request->withOrdering($request->withFilters(
            $query->enquiry()->where('enquiry_status', 'in-conversation')->orderBy('enquired_at', 'DESC')
        ));
    }
    ...
    {
        return 'enquiries-in-conversation';
    }
}
