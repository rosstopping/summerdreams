<x-layouts.app>
    <div class="relative -mt-28 overflow-hidden bg-[#fff7ef] pt-28 text-gray-950 sm:-mt-32 sm:pt-32">
        ...
        <div aria-hidden="true" class="pointer-events-none absolute left-[-3rem] top-20 h-28 w-28 rounded-full border-4 border-black/80 bg-[#7fe7ff] blur-[2px]"></div>
        ...
        <div class="relative mx-auto max-w-7xl px-4 pb-32 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-2xl text-center">
                ...
                <div class="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
                    ...
                    <a href="/book" class="inline-flex items-center justify-center rounded-full border-2 border-black bg-white px-8 py-3 text-sm font-black uppercase tracking-[0.18em] text-black shadow-[4px_4px_0_0_#171717] transition-transform duration-200 hover:-translate-y-1">
                        Book Another
                    </a>
                </div>
            </div>
