<section class="py-12">
    <div class="container mx-auto px-6 flex flex-wrap md:flex-nowrap justify-between gap-24">
        <div class="w-full md:w-5/12 py-12 md:py-20">
            ...
            <div data-sal="fade" data-sal-delay="300" data-sal-duration="1000" data-sal-easing="ease-in-out" class="prose text-gray-700 mt-8 text-lg max-w-none leading-relaxed [&>*:first-child]:mt-0">
        ...
        <div class="w-full md:flex-1 relative md:py-6">
            @if (data_get($content, 'image'))
                <div class="relative overflow-hidden rounded-3xl border-4 border-black shadow-[8px_8px_0px_rgba(0,0,0,0.1)]" data-sal="slide-right" data-sal-delay="300" data-sal-duration="1000" data-sal-easing="ease-in-out">
