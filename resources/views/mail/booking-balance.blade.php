  ...
  <body style="word-spacing:normal;background-color:#FFFFFF;">
    ...
    <!-- <mj-section padding-top="30px" padding-bottom="0px">
      ...
      >Dear {{ $booking->name }},<br></br>
          In order to guarantee your event tickets we need a final deposit installment of £35 per person, which you can easily <a href="{{ url('account') }}">pay here</a>.
          
          <br /><br />Many thanks<br />
          VVIP Resort Team</div>
