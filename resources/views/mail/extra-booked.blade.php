  ...
  <body style="word-spacing:normal;background-color:#FFF7EF;">
    ...
    <!-- <mj-section padding-top="30px" padding-bottom="0px">
      ...
      >Dear {{ $booking->name }},<br></br>
          Thank you, for your payment for <strong>{{ $extra->name }}</strong>. Our resort team will tell you everything you need to know when you check in and pick up your event wristbands. <br></br>
