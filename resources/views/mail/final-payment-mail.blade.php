    ...
    <!-- <mj-section padding-top="30px" padding-bottom="0px">
      ...
      >
        <tbody>
              ...
              <tr>
                <td
                   align="left" style="font-size:0px;padding:0px;padding-bottom:20px;word-break:break-word;"
                >
      ...
      >Dear {{ $booking->name }},<br></br>
            Thank you, we have received your full payment of £{{ $payment }} <br /><br />
            We will be in touch before you leave to arrange a time to come into our office and pick up your event wristbands.<br /><br />
      ...
      >Name</div>
              ...
              <tr>
                <td
                   align="left" style="font-size:0px;padding:0px;padding-top:10px;word-break:break-word;"
                >
      ...
      >Event</div>
            ...
            @foreach ($booking->dates as $event => $date)
              <tr>
                <td
                   align="left" style="font-size:0px;padding:0px;padding-top:10px;word-break:break-word;"
                >
      ...
      >
        <tbody>
              ...
              <tr>
                <td
                   align="center" style="font-size:0px;padding:0px;padding-top:20px;word-break:break-word;"
                >
